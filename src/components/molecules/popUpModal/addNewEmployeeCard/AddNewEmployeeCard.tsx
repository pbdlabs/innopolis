...
const AddNewEmployeeCard = ({
  ...
  const onFinish = async (values: any) => {
    ...
    const departmentValue = isAddEmployee
      ? Number(getValues.DepartmentName)
      : getDepartmentValue();
    const roleValue = isAddEmployee
      ? Number(getValues.RoleName)
      : getDepartmentValue();
    ...
    const editEmployeeInfo = {
      ...employeeInfo,
      admin_pass: getValues.adminPassword || null,
      id: Number(employeeDetails?.Id),
    };
    ...
    const responseEditEmployee =
      !isAddEmployee && patchEmployeeDetails(editEmployeeInfo);
  ...
  return (
    <Modal
      title={isAddEmployee ? "Onboard New Employee" : "Change Employee details"}
      open={isModalOpen}
      onOk={handleOk}
    ...
    >
      ...
      >
        ...
        <Form.Item noStyle shouldUpdate={changePassword || isAddEmployee}>
          {() =>
